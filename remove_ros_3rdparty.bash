...
#Classes
PATTERNS="${PATTERNS} PointField:PCLPointField PointCloud2:PointCloud2 Image:PCLImage Header:PCLHeader"
#Functions
PATTERNS="${PATTERNS} toROSMsg:toPointCloud2 fromROSMsg:fromPointCloud2"
#Moved files
